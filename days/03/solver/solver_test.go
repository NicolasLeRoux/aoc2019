...
func TestParseWirePath(t *testing.T) {
	suites := []struct {
		...
		{"Should go to 'right'.", "R2", map[string]bool{"0,0": true, "1,0": true, "2,0": true}},
		{"Should go to 'left'.", "L1", map[string]bool{"0,0": true, "-1,0": true}},
		{"Should go to 'up'.", "U1", map[string]bool{"0,0": true, "0,-1": true}},
		{"Should go to 'down'.", "D2", map[string]bool{"0,0": true, "0,1": true, "0,2": true}},
		{"Should go to 'up' then 'right'.", "U1,R2", map[string]bool{"0,0": true, "0,-1": true, "1,-1": true, "2,-1": true}},
		{"Should go to 'down' then 'left'.", "D1,L2", map[string]bool{"0,0": true, "0,1": true, "-1,1": true, "-2,1": true}},
	}
