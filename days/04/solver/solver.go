...
// SolvePartTwo is the main solver of the day 04 part 2 puzzle
func SolvePartTwo(min int, max int) int {
	var list []int
	...
	for i := min; i <= max; i++ {
		...
		if digit1 <= digit2 && digit2 <= digit3 && digit3 <= digit4 && digit4 <= digit5 && digit5 <= digit6 && (digit1 == digit2 || digit2 == digit3 || digit3 == digit4 || digit4 == digit5 || digit5 == digit6) {
			...
			if digit2 != digit3 && digit3 == digit4 && digit4 != digit5 {
				pairs++
			}
			if digit3 != digit4 && digit4 == digit5 && digit5 != digit6 {
				pairs++
			}
			if digit4 != digit5 && digit5 == digit6 {
				pairs++
			}
