...
The Elves have sent you some __Amplifier Controller Software__ (your puzzle input), a program that should run on your [existing Intcode computer](../05). Each amplifier will need to run a copy of the program.
